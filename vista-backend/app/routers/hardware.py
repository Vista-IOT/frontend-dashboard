"""
Hardware router for the Vista IoT Backend.
...
@router.get("/serial-ports", response_model=ApiResponse)
async def get_serial_ports():
    """Get a list of all available serial ports."""
    try:
        return ApiResponse(
            status="success",
            data={"serial_ports": HardwareDetector.detect_serial_ports()}
        )
    except Exception as e:
...
@router.get("/network-interfaces", response_model=ApiResponse)
async def get_network_interfaces():
    """Get a list of all network interfaces."""
    try:
        return ApiResponse(
            status="success",
            data={"network_interfaces": HardwareDetector.detect_network_interfaces()}
        )
    except Exception as e:
...
@router.get("/gpio", response_model=ApiResponse)
async def get_gpio_info():
    """Get information about available GPIO."""
    try:
        return ApiResponse(
            status="success",
            data={"gpio": HardwareDetector.detect_gpio()}
        )
    except Exception as e:
...
@router.get("/usb-devices", response_model=ApiResponse)
async def get_usb_devices():
    """Get a list of connected USB devices."""
    try:
        return ApiResponse(
            status="success",
            data={"usb_devices": HardwareDetector.detect_usb_devices()}
        )
    except Exception as e:
